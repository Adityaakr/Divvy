...
// Import enhanced screens (without Privy dependencies for now)
...
// Enhanced demo home screen
function DemoHomeScreen({ navigation }: any) {
  return (
    <View style={styles.screen}>
      <Text style={styles.title}>🚀 SplitSafe DeFi</Text>
      <Text style={styles.subtitle}>Complete Web3 Mobile DApp</Text>
